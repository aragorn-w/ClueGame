...
public class BoardTestsExp {
	...
	public void testAdjacency() {
		...
		// Right side
		testBoardCell = board.getCell(2, 3);
		adj = testBoardCell.getAdjList();
	...
	public void testMakeTargetsNormal() {
		...
		TestBoardCell testBoardCell = board.getCell(1, 1);
	...
	public void testMakeTargetsSpecial() {
		...
		// this should be 2 less than the previous as both are located at the extremities of the target list
	...
	public void testMaxRoll() {
		...
		// this should be every cell in the board except the test cell
		TestBoardCell testBoardCell = board.getCell(0, 0);
